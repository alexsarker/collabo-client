        ...
        <div className="dropdown">
          ...
          >
            {user ? (
              ...
              <>
                <li>
                  <Link to="/assignments" className="text-white mr-8">
                    Assignments
                  </Link>
                </li>
                <li>
                  <Link to="/aboutUs" className="text-white mr-8">
                    About Us
                  </Link>
                </li>
              </>
        ...
        <ul className="menu menu-horizontal px-2 hidden lg:block">
          <div className="flex">
            {user ? (
              <>
                <li>
                  <Link to="/createPage" className="text-white mr-8">
                    Create Assignment
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link to="/pending" className="text-white mr-8">
                    Pending Assignments
                  </Link>
                </li>
                <li>
