...
import LogoBlack from "/src/assets/logoblack.svg";
        ...
        <div className="dropdown">
          ...
          >
            {user ? (
              <>
                <li>
                  <Link to="/createPage">Create Assignment</Link>
                </li>
                <li>
              ...
              <>
                <li>
                  <Link to="/assignments" className="mr-8">
                    Assignments
                  </Link>
                </li>
                <li>
                  <Link to="/aboutUs" className="mr-8">
                    About Us
                  </Link>
                </li>
              </>
      ...
      <div className="navbar-end">
        <ul className="menu menu-horizontal px-2 hidden lg:block">
          <div className="flex">
            {user ? (
              <>
                <li>
                  <Link to="/createPage" className="mr-8">
                    Create Assignment
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link to="/pending" className="mr-8">
                    Pending Assignments
                  </Link>
                </li>
                <li>
        ...
        {user ? (
          <div className="dropdown dropdown-end">
            ...
            >
              <li>
                <Link to="/mySubmit">My Attempted Assignments</Link>
              </li>
              <li>
                <Link to="/aboutUs">About Us</Link>
              </li>
